...
$ecms_config['esafe']['ecookiernd']='UzAJPfiba82J9M4UJydNT5siHgCf9dmd0tVX';	//后台登录COOKIE认证码(填写10~50个任意字符，最好多种字符组合)
...
$ecms_config['cks']['ckvarpre']='eqfku';		//前台cookie变量前缀
$ecms_config['cks']['ckadminvarpre']='eicds';		//后台cookie变量前缀
$ecms_config['cks']['ckrnd']='oKMmUQgOkutPnuKVOcvD17KvGXNTYWdzY6U';	//COOKIE验证随机码(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndtwo']='dsEIqM7ahUDIYABhPs1pUzMIRG64yH2RZ4';	//COOKIE验证随机码2(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndthree']='bic7Sfgm4tkhm3ZJ7U3xzlibgdUnSe3o6';	//COOKIE验证随机码3(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndfour']='e8xpokCJDMTS5bQWHPh6gkXyuy14OaOw';	//COOKIE验证随机码4(填写10~50个任意字符，最好多种字符组合)
$ecms_config['cks']['ckrndfive']='tNIZGfTuCAC56W7dmEyLW0Btt14eSBM';	//COOKIE验证随机码5(填写10~50个任意字符，最好多种字符组合)

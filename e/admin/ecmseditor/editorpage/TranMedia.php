...
function echoViewFile(obj,ecms){
  ...
  <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" id="tranpictb">
    <form id="TranMediaFormT" name="TranMediaFormT" method="post" target="eeditoruploadmedia<?=$ecms_topager['InstanceId']?>" enctype="multipart/form-data" action="../ecmseditor.php" onsubmit="return DoCheckTranFile(TranMediaFormT);">
	<?=$ecms_hashur['form']?>

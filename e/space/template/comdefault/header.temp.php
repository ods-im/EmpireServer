...
<table border="0" cellspacing="0" cellpadding="0">
        <tr> 
          ...
          <td width="70" height="24" onMouseOver="ChangeMenuBg(this,mhome)" onMouseOut="ChangeMenuBg2(this,mhome)" align="center" onClick="self.location.href='index.php?userid=<?=$userid?>';"><font color="#FFFFFF" id="mhome"><strong>空间首页</strong></font></td>
			<?=$dhmenu?>
          <td width="70" height="24" onMouseOver="ChangeMenuBg(this,muserinfo)" onMouseOut="ChangeMenuBg2(this,muserinfo)" align="center" onClick="self.location.href='UserInfo.php?userid=<?=$userid?>';"><font color="#FFFFFF" id="muserinfo"><strong>公司介绍</strong></font></td>
		  <td width="70" height="24" onMouseOver="ChangeMenuBg(this,mfeedback)" onMouseOut="ChangeMenuBg2(this,mfeedback)" align="center" onClick="self.location.href='feedback.php?userid=<?=$userid?>';"><font color="#FFFFFF" id="mfeedback"><strong>反馈信息</strong></font></td>
